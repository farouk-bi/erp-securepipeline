#!/bin/bash
# scripts/blue-green-switch.sh — Bascule Blue/Green
# Usage : ./blue-green-switch.sh <new_slot> <image_tag>
#   new_slot: blue ou green
#   image_tag: tag de l'image Docker (ex: 42)
